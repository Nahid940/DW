<h2>Select requirements for <b>puppy socialisation</b> service</h2>
           <form action="" method="post" onSubmit="return check(this)" class='bookform' name='bookform'>
                ...
                <table>
                   ...
                   <tr>
                       ...
                       <td>
					    <div id="error7"></div>
                <select style="width:200px;" name="pet" id="select">
				...
				<td>
                  ...
                  <td>
					<?php
						$sid="Select serviceid from service where service_name='Puppy socialisation'";
            ...
            <td><input  id="datepicker" name='day'/>
			</td>
